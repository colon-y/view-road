	...
	<section id="warp">
		<div class="container board-container" >
			...
			<ul class="board-right-tab" style="float: none; text-align: right;display:block;  height: 50px;">
				<li><a class="button right-board" href="/place/introduction/list">목록 보기</a></li>
			</ul>            	
            	
			<div class="panel panel-warning" style="border: 1px solid #dadada;">
				<div class="panel-title box-subject" style="border-bottom: 1px solid #dadada;">장소 소개 글쓰기</div>
				<div class="container boardWriteForm" style="width: 100%;">

					<form name="form1" id="form1" action="/place/introduction/write" enctype="multipart/form-data" method="post">
