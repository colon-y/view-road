...
@font-face {
	...
	font-style: blod;
	font-weight: 800;
	src:url('https://cdn.jsdelivr.net/gh/braverokmc79/dknbtech@v1.0.2/asset/font/NotoSansKR-Bold.otf')
		format('opentype');
}
</style>
<script>
...
<body translate="no">
	<div class="ag-page-404">
		<h1 style="text-align: center; font-size: 35px; font-family: 'NotoSansKR-bold'">404 페이지를 찾을수 없습니다.</h1>
