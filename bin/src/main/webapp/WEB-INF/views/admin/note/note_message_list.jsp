...
<c:forEach items="${messageList}" var="row">
	...
	<c:if test="${param.receiveId eq row.receiveId }">
		<div class="incoming_msg mt-5 mb-5">
			<div class="incoming_msg_img">
			
			<span class="userColor ${row.userColor}">
...
<%-- 					 | <c:if test="${row.remove!=1}">
	...
	<c:if test="${param.receiveId eq row.sendId }">
		<div class="outgoing_msg" style="display: flex;justify-content: flex-end;">
		
			<div class="incoming_msg_img" style="margin-right: 20px;">
