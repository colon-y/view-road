        ...
        <div class="container read-container" >
			...
			<div class="row">
            	...
            	<ul class="board-right-tab mt-0">             	
            		<li>            		
            			<a class="button right-board" href="/place/reviews/list">목록 보기</a>
            		</li>
     			    <c:if test="${not empty USER and (USER.role eq 'ROLE_ADMIN') or (USER.role eq 'ROLE_MANAGER') }">
							<li style="margin-right: 10px">
								<a class="button right-board" href="/place/reviews/write">글쓰기</a>
							</li>	
					</c:if>           		            	            
            	</ul>
            ...
            <div class="sub_wrap">
            	 <p>
      			...
      			<form method="post" action="/place/reviews/boardEditDirect"  id="directForm"> 
