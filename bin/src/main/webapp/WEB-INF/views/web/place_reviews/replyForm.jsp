...
<input id="clicktoshow1" class="hidden form-control tooltipstered" min="1" maxlength="10" 
...
name="replyPassword" type="password"  placeholder="비밀번호 (4자)"  >
          	  ...
          	  <c:choose>
					...
					<c:otherwise>
							<button class="button form-control tooltipstered wsubmit" type="button"
							 	style=" color: #fff;
								    background-color: #f38f0a;
								    opacity: .8;
								    border: 1px solid #f38f0a;
								    margin: 0px !important;
								    padding-bottom:30px;
								    font-weight: normal;								    
								" onclick="alert('로그인후 댓글쓰기가 가능합니다.')">로그인후 댓글쓰기가 가능합니다.
							 	</button>												
				</c:otherwise>
			</c:choose>              
 ...
 <div id="boardComment" class="panel-footer board board-view-comment">
       ...
       <p><textarea id="submitbtn" class="form-control tooltipstered" minlength="1" maxlength="500" required
       aria-required="true" name="content"   placeholder="댓글을 입력해주세요 (최대 500자)"   ></textarea>
       </p>                    
