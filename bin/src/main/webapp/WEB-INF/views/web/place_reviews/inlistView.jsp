...
<ul class="board-list" id="listView">
	<c:forEach items="${likeList }" var="row">
		<li style="background-color: #f6f6f6; font-size: 14px; padding: 10px 0px"><a href="/place/reviews/read/${row.bno}?page=${pageMaker.page}" style="padding: 10px 18px; line-height: 33px;">
	...
	<c:forEach items="${list }" var="row">
		<li style="font-size: 14px;" class="${row.bno eq bno ? 'active':''}"><a href="/place/reviews/read/${row.bno}?page=${pageMaker.page}" style="padding: 10px 18px; line-height: 33px;"> <span
