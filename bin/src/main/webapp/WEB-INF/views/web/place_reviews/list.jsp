	...
	<section id="warp">
		...
		<div class="row">
			...
			<div class="bn-box con">
				<h1 class="warp-title">장소 후기</h1>
				<div class="img-box" >
					<img src="/resources/web/images/ban_2.jpg" alt="장소 후기" class="img-responsive img-rounded">
				</div>
			</div>	
			</div>
		</div> 
			...
			<div class="row" >					
				<form method="get" action="/place/reviews/list" >
			...
			<div class="list con">
				<ul class="row">
					<c:forEach items="${list}" var="row" varStatus="status">
						<li  class="cell ${status.index %4 ==0? 'on':''}  ${(status.count%4==0) ? 'on3':'' }" onclick="location.href='/place/reviews/read/${row.bno}?keyword=${param.keyword}&st=${param.st}'" >
							<div class="img-box">
								<c:choose>
