...
<div class="login-page">
  ...
  <div class="form">
    ...
    <form class="login-form" name="signup" method="post"  id="loginForm" action="/login">      	
    	<h2 class="login-page-form-title">비밀번호 찾기</h2>
    	    
    <p>
       <input type="text"  id="userId1"  name="userId1"  placeholder="아이디를 입력해 주세요." >	
      <input type="text"  id="phone"  name="phone"  placeholder="휴대전화 번호를 입력해 주세요."   oninput="autoHyphen(this)" maxlength="13">	
      <button type="button" onclick="findPhonePassword()">휴대전화 번호로 찾기</button>
    </p>	 
   
    <hr>
     <p>
     <input type="text"  id="userId2"  name="userId2"  placeholder="아이디를 입력해 주세요." >
      <input type="email"  id="email"  name="email"  placeholder="이메일을 입력해 주세요." >	
      <button type="button" onclick="findEmailPassword()">이메일로 찾기</button>
    </p>		
